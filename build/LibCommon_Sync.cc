...
cs_6('x'),
cs_7('y');
static const unsigned char module_checksum[] = { 0xeb, 0x1a, 0xa8, 0x39, 0xc3, 0x38, 0x62, 0xd2, 0xd2, 0x0b, 0x30, 0x4f, 0xd0, 0xdc, 0x75, 0x77 };
...
TTCN_Module module_object("LibCommon_Sync", __DATE__, __TIME__, module_checksum, pre_init_module, NULL, 0U, 4294967295U, 4294967295U, 4294967295U, NULL, 0LU, 0, post_init_module, set_module_param, get_module_param, log_module_param, init_comp_type, start_ptc_function, NULL);
...
void TestcaseStep::set_param(Module_Param& param)
{
  ...
  if (mp->get_type()!=Module_Param::MP_Enumerated) param.type_error("enumerated value", "@LibCommon_Sync.TestcaseStep");
...
Module_Param* TestcaseStep::get_param(Module_Param_Name& /* param_name */) const
{
  if (!is_bound()) {
...
void TestcaseStep_template::set_param(Module_Param& param)
{
  ...
  if (param.get_type() == Module_Param::MP_Reference) {
    char* enum_name = param.get_enumerated();
    TestcaseStep::enum_type enum_val = (enum_name != NULL) ? TestcaseStep::str_to_enum(enum_name) : TestcaseStep::UNKNOWN_VALUE;
  ...
  case Module_Param::MP_Enumerated: {
    TestcaseStep::enum_type enum_val = TestcaseStep::str_to_enum(mp->get_enumerated());
    if (!TestcaseStep::is_valid_enum(enum_val)) {
      param.error("Invalid enumerated value for type @LibCommon_Sync.TestcaseStep.");
    }
    *this = enum_val;
...
Module_Param* TestcaseStep_template::get_param(Module_Param_Name& param_name) const
{
  ...
  case ANY_OR_OMIT:
    ...
    break;
  case SPECIFIC_VALUE:
    mp = new Module_Param_Enumerated(mcopystr(TestcaseStep::enum_to_str(single_value)));
    break;
  case VALUE_LIST:
  case COMPLEMENTED_LIST: {
...
alt_status SyncPort::receive(const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
...
alt_status SyncPort::check_receive(const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status SyncPort::trigger(const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status SyncPort::receive(const SyncCmd_template& value_template, SyncCmd *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status SyncPort::check_receive(const SyncCmd_template& value_template, SyncCmd *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
...
alt_status SyncPort::trigger(const SyncCmd_template& value_template, SyncCmd *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr)
{
msg_queue_item *my_head = (msg_queue_item*)msg_queue_head;
if (msg_queue_head == NULL) {
if (is_started) return ALT_MAYBE;
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] < '0' || param_field[0] > '9') {
      param.error("Unexpected record field name in module parameter, expected a valid"
        " index for record of type `@LibCommon_Sync.ClientSyncCompList'");
    }
    int param_index = -1;
...
Module_Param* ClientSyncCompList::get_param(Module_Param_Name& param_name) const
{
  if (!is_bound()) {
    return new Module_Param_Unbound();
  }
  if (param_name.next_name()) {
    ...
    if (param_field[0] < '0' || param_field[0] > '9') {
      TTCN_error("Unexpected record field name in module parameter reference, "
        "expected a valid index for record of type `@LibCommon_Sync.ClientSyncCompList'");
    }
    int param_index = -1;
    sscanf(param_field, "%d", &param_index);
...
void ClientSyncCompList_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] < '0' || param_field[0] > '9') {
      param.error("Unexpected record field name in module parameter, expected a valid"
        " index for record template type `@LibCommon_Sync.ClientSyncCompList'");
    }
    int param_index = -1;
    sscanf(param_field, "%d", &param_index);
    (*this)[param_index].set_param(param);
...
Module_Param* ClientSyncCompList_template::get_param(Module_Param_Name& param_name) const
{
  if (param_name.next_name()) {
    char* param_field = param_name.get_current_name();
    if (param_field[0] < '0' || param_field[0] > '9') {
      TTCN_error("Unexpected record field name in module parameter reference, "
        "expected a valid index for record of template type `@LibCommon_Sync.ClientSyncCompList'");
    }
    int param_index = -1;
    sscanf(param_field, "%d", &param_index);
    return (*this)[param_index].get_param(param_name);
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for union type `@LibCommon_Sync.SyncCmd'");
    }
    if (strcmp("clientReady", param_field) == 0) {
      ...
      return;
    } else param.error("Field `%s' not found in union type `@LibCommon_Sync.SyncCmd'", param_field);
  }
...
Module_Param* SyncCmd::get_param(Module_Param_Name& param_name) const
{
  if (!is_bound()) {
    return new Module_Param_Unbound();
  }
  if (param_name.next_name()) {
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      TTCN_error("Unexpected array index in module parameter reference, "
        "expected a valid field name for union type `@LibCommon_Sync.SyncCmd'");
    }
    if (strcmp("clientReady", param_field) == 0) {
      return clientReady().get_param(param_name);
    } else if (strcmp("serverReady", param_field) == 0) {
      return serverReady().get_param(param_name);
    } else if (strcmp("clientStop", param_field) == 0) {
      return clientStop().get_param(param_name);
    } else if (strcmp("serverStop", param_field) == 0) {
      return serverStop().get_param(param_name);
    } else TTCN_error("Field `%s' not found in union type `SyncCmd'", param_field);
  }
  Module_Param* mp_field = NULL;
  switch(union_selection) {
  case ALT_clientReady:
    mp_field = field_clientReady->get_param(param_name);
    mp_field->set_id(new Module_Param_FieldName(mcopystr("clientReady")));
    break;
  case ALT_serverReady:
    mp_field = field_serverReady->get_param(param_name);
    mp_field->set_id(new Module_Param_FieldName(mcopystr("serverReady")));
    break;
  case ALT_clientStop:
    mp_field = field_clientStop->get_param(param_name);
    mp_field->set_id(new Module_Param_FieldName(mcopystr("clientStop")));
    break;
  case ALT_serverStop:
    mp_field = field_serverStop->get_param(param_name);
    mp_field->set_id(new Module_Param_FieldName(mcopystr("serverStop")));
    break;
  default:
    break;
  }
...
TTCN_error("Performing valueof or send operation on a non-specific template of union type @LibCommon_Sync.SyncCmd.");
SyncCmd ret_val;
switch (single_value.union_selection) {
case SyncCmd::ALT_clientReady:
...
Module_Param* SyncCmd_template::get_param(Module_Param_Name& param_name) const
{
  if (param_name.next_name()) {
    char* param_field = param_name.get_current_name();
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      TTCN_error("Unexpected array index in module parameter reference, "
        "expected a valid field name for union template type `@LibCommon_Sync.SyncCmd'");
    }
    if (strcmp("clientReady", param_field) == 0) {
      return clientReady().get_param(param_name);
    } else if (strcmp("serverReady", param_field) == 0) {
  ...
  case SPECIFIC_VALUE: {
    ...
    switch(single_value.union_selection) {
    case SyncCmd::ALT_clientReady:
      mp_field = single_value.field_clientReady->get_param(param_name);
      mp_field->set_id(new Module_Param_FieldName(mcopystr("clientReady")));
      break;
    case SyncCmd::ALT_serverReady:
      mp_field = single_value.field_serverReady->get_param(param_name);
      mp_field->set_id(new Module_Param_FieldName(mcopystr("serverReady")));
      break;
    case SyncCmd::ALT_clientStop:
      mp_field = single_value.field_clientStop->get_param(param_name);
      mp_field->set_id(new Module_Param_FieldName(mcopystr("clientStop")));
      break;
    case SyncCmd::ALT_serverStop:
      mp_field = single_value.field_serverStop->get_param(param_name);
      mp_field->set_id(new Module_Param_FieldName(mcopystr("serverStop")));
      break;
    default:
      break;
...
int ClientReady::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @LibCommon_Sync.ClientReady");
  return 1;
}
...
void ClientReady::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@LibCommon_Sync.ClientReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      syncPointId().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@LibCommon_Sync.ClientReady'", param_field);
  }
  ...
  case Module_Param::MP_Value_List:
    if (1<mp->get_size()) {
      param.error("record value of type @LibCommon_Sync.ClientReady has 1 fields but list value has %d fields", (int)mp->get_size());
    }
    if (mp->get_size()>0 && mp->get_elem(0)->get_type()!=Module_Param::MP_NotUsed) syncPointId().set_param(*mp->get_elem(0));
    break;
  case Module_Param::MP_Assignment_List: {
    ...
    for (size_t val_idx=0; val_idx<mp->get_size(); val_idx++) if (!value_used[val_idx]) {
      mp->get_elem(val_idx)->error("Non existent field name in type @LibCommon_Sync.ClientReady: %s", mp->get_elem(val_idx)->get_id()->get_name());
      break;
    }
  } break;
  default:
...
Module_Param* ClientReady::get_param(Module_Param_Name& param_name) const
{
  if (!is_bound()) {
    return new Module_Param_Unbound();
  }
  if (param_name.next_name()) {
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      TTCN_error("Unexpected array index in module parameter reference, "
        "expected a valid field name for record type `@LibCommon_Sync.ClientReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      return syncPointId().get_param(param_name);
    } else TTCN_error("Field `%s' not found in record type `@LibCommon_Sync.ClientReady'", param_field);
  }
  Module_Param_Assignment_List* mp = new Module_Param_Assignment_List();
  Module_Param* mp_field_syncPointId = field_syncPointId.get_param(param_name);
  mp_field_syncPointId->set_id(new Module_Param_FieldName(mcopystr("syncPointId")));
  mp->add_elem(mp_field_syncPointId);
  return mp;
  }
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @LibCommon_Sync.ClientReady.");
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @LibCommon_Sync.ClientReady.");
ClientReady ret_val;
...
void ClientReady_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@LibCommon_Sync.ClientReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      syncPointId().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@LibCommon_Sync.ClientReady'", param_field);
  }
  ...
  case Module_Param::MP_Value_List:
    if (1<mp->get_size()) {
      param.error("record template of type @LibCommon_Sync.ClientReady has 1 fields but list value has %d fields", (int)mp->get_size());
    }
    if (mp->get_size()>0 && mp->get_elem(0)->get_type()!=Module_Param::MP_NotUsed) syncPointId().set_param(*mp->get_elem(0));
    break;
  case Module_Param::MP_Assignment_List: {
...
Module_Param* ClientReady_template::get_param(Module_Param_Name& param_name) const
{
  if (param_name.next_name()) {
    char* param_field = param_name.get_current_name();
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      TTCN_error("Unexpected array index in module parameter reference, "
        "expected a valid field name for record template type `@LibCommon_Sync.ClientReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      return syncPointId().get_param(param_name);
    } else TTCN_error("Field `%s' not found in record type `@LibCommon_Sync.ClientReady'", param_field);
  ...
  case SPECIFIC_VALUE: {
    mp = new Module_Param_Assignment_List();
    Module_Param* mp_field_syncPointId = single_value->field_syncPointId.get_param(param_name);
    mp_field_syncPointId->set_id(new Module_Param_FieldName(mcopystr("syncPointId")));
    mp->add_elem(mp_field_syncPointId);
    break; }
  case VALUE_LIST:
...
int ServerReady::size_of() const
{
  if (!is_bound()) TTCN_error("Calculating the size of an unbound record/set value of type @LibCommon_Sync.ServerReady");
  return 1;
}
...
void ServerReady::set_param(Module_Param& param)
{
  ...
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record type `@LibCommon_Sync.ServerReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      syncPointId().set_param(param);
      return;
    } else param.error("Field `%s' not found in record type `@LibCommon_Sync.ServerReady'", param_field);
  }
  param.basic_check(Module_Param::BC_VALUE, "record value");
  Module_Param_Ptr mp = &param;
  if (param.get_type() == Module_Param::MP_Reference) {
  ...
  case Module_Param::MP_Value_List:
    if (1<mp->get_size()) {
      param.error("record value of type @LibCommon_Sync.ServerReady has 1 fields but list value has %d fields", (int)mp->get_size());
    }
    if (mp->get_size()>0 && mp->get_elem(0)->get_type()!=Module_Param::MP_NotUsed) syncPointId().set_param(*mp->get_elem(0));
    break;
  case Module_Param::MP_Assignment_List: {
    ...
    for (size_t val_idx=0; val_idx<mp->get_size(); val_idx++) if (!value_used[val_idx]) {
      mp->get_elem(val_idx)->error("Non existent field name in type @LibCommon_Sync.ServerReady: %s", mp->get_elem(val_idx)->get_id()->get_name());
      break;
    }
  } break;
  default:
...
Module_Param* ServerReady::get_param(Module_Param_Name& param_name) const
{
  if (!is_bound()) {
    return new Module_Param_Unbound();
  }
  if (param_name.next_name()) {
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      TTCN_error("Unexpected array index in module parameter reference, "
        "expected a valid field name for record type `@LibCommon_Sync.ServerReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      return syncPointId().get_param(param_name);
    } else TTCN_error("Field `%s' not found in record type `@LibCommon_Sync.ServerReady'", param_field);
  }
  Module_Param_Assignment_List* mp = new Module_Param_Assignment_List();
  Module_Param* mp_field_syncPointId = field_syncPointId.get_param(param_name);
  mp_field_syncPointId->set_id(new Module_Param_FieldName(mcopystr("syncPointId")));
...
{
if (!is_bound()) TTCN_error("Text encoder: Encoding an unbound record/set value of type @LibCommon_Sync.ServerReady.");
field_syncPointId.encode_text(text_buf);
}
...
{
if (template_selection != SPECIFIC_VALUE || is_ifpresent)
TTCN_error("Performing valueof or send operation on a non-specific template of type @LibCommon_Sync.ServerReady.");
ServerReady ret_val;
if (single_value->field_syncPointId.is_bound()) {
ret_val.syncPointId() = single_value->field_syncPointId.valueof();
}
...
void ServerReady_template::set_param(Module_Param& param)
{
  if (dynamic_cast<Module_Param_Name*>(param.get_id()) != NULL &&
    ...
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      param.error("Unexpected array index in module parameter, expected a valid field"
        " name for record template type `@LibCommon_Sync.ServerReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      syncPointId().set_param(param);
      return;
    } else param.error("Field `%s' not found in record template type `@LibCommon_Sync.ServerReady'", param_field);
  }
  param.basic_check(Module_Param::BC_TEMPLATE, "record template");
  Module_Param_Ptr mp = &param;
  if (param.get_type() == Module_Param::MP_Reference) {
  ...
  case Module_Param::MP_Value_List:
    if (1<mp->get_size()) {
      param.error("record template of type @LibCommon_Sync.ServerReady has 1 fields but list value has %d fields", (int)mp->get_size());
    }
    if (mp->get_size()>0 && mp->get_elem(0)->get_type()!=Module_Param::MP_NotUsed) syncPointId().set_param(*mp->get_elem(0));
    break;
  case Module_Param::MP_Assignment_List: {
...
Module_Param* ServerReady_template::get_param(Module_Param_Name& param_name) const
{
  if (param_name.next_name()) {
    char* param_field = param_name.get_current_name();
    if (param_field[0] >= '0' && param_field[0] <= '9') {
      TTCN_error("Unexpected array index in module parameter reference, "
        "expected a valid field name for record template type `@LibCommon_Sync.ServerReady'");
    }
    if (strcmp("syncPointId", param_field) == 0) {
      return syncPointId().get_param(param_name);
    } else TTCN_error("Field `%s' not found in record type `@LibCommon_Sync.ServerReady'", param_field);
...
Module_Param* ClientStop::get_param(Module_Param_Name& /* param_name */) const
{
  if (!is_bound()) {
    return new Module_Param_Unbound();
  }
...
void ClientStop_template::set_param(Module_Param& param)
{
  ...
  case Module_Param::MP_ComplementList_Template: {
    ...
    *this = temp;
    break; }
  case Module_Param::MP_Value_List:
    if (mp->get_size()>0) param.type_error("empty record/set template", "@LibCommon_Sync.ClientStop");
    *this = NULL_VALUE;
    break;
  default:
...
Module_Param* ClientStop_template::get_param(Module_Param_Name& param_name) const
{
  Module_Param* mp = NULL;
  switch (template_selection) {
  case UNINITIALIZED_TEMPLATE:
...
Module_Param* ServerStop::get_param(Module_Param_Name& /* param_name */) const
{
  if (!is_bound()) {
    return new Module_Param_Unbound();
  }
...
void ServerStop_template::set_param(Module_Param& param)
{
  ...
  case Module_Param::MP_ComplementList_Template: {
    ...
    *this = temp;
    break; }
  case Module_Param::MP_Value_List:
    if (mp->get_size()>0) param.type_error("empty record/set template", "@LibCommon_Sync.ServerStop");
    *this = NULL_VALUE;
    break;
  default:
...
Module_Param* ServerStop_template::get_param(Module_Param_Name& param_name) const
{
  Module_Param* mp = NULL;
  switch (template_selection) {
  case UNINITIALIZED_TEMPLATE:
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 188, TTCN_Location::LOCATION_FUNCTION, "f_connect4SelfOrClientSync");
current_location.update_lineno(190);
/* LibCommon_Sync.ttcn, line 190 */
if ((self == MTC_COMPREF)) {
current_location.update_lineno(191);
/* LibCommon_Sync.ttcn, line 191 */
f__connect4SelfSync();
}
else {
current_location.update_lineno(193);
/* LibCommon_Sync.ttcn, line 193 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 210, TTCN_Location::LOCATION_FUNCTION, "f_disconnect4SelfOrClientSync");
current_location.update_lineno(212);
/* LibCommon_Sync.ttcn, line 212 */
if ((self == MTC_COMPREF)) {
current_location.update_lineno(213);
/* LibCommon_Sync.ttcn, line 213 */
f__disconnect4SelfSync();
}
else {
current_location.update_lineno(215);
/* LibCommon_Sync.ttcn, line 215 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 243, TTCN_Location::LOCATION_FUNCTION, "f_serverSync2ClientsAndStop");
current_location.update_lineno(245);
/* LibCommon_Sync.ttcn, line 245 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 268, TTCN_Location::LOCATION_FUNCTION, "f_serverSync3ClientsAndStop");
current_location.update_lineno(270);
/* LibCommon_Sync.ttcn, line 270 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 293, TTCN_Location::LOCATION_FUNCTION, "f_serverSync4ClientsAndStop");
current_location.update_lineno(295);
/* LibCommon_Sync.ttcn, line 295 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 319, TTCN_Location::LOCATION_FUNCTION, "f_serverSyncNClientsAndStop");
current_location.update_lineno(323);
/* LibCommon_Sync.ttcn, line 323 */
INTEGER i;
current_location.update_lineno(323);
/* LibCommon_Sync.ttcn, line 323 */
INTEGER v__noOfSyncIds(p__syncPointIds.size_of());
current_location.update_lineno(324);
/* LibCommon_Sync.ttcn, line 324 */
i = 0;
current_location.update_lineno(324);
/* LibCommon_Sync.ttcn, line 324 */
for ( ; ; ) {
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 353, TTCN_Location::LOCATION_FUNCTION, "f_serverSync2ClientsUtAndStop");
current_location.update_lineno(355);
/* LibCommon_Sync.ttcn, line 355 */
INTEGER i;
current_location.update_lineno(355);
/* LibCommon_Sync.ttcn, line 355 */
INTEGER v__noOfSyncIds(p__syncPointIds.size_of());
current_location.update_lineno(356);
/* LibCommon_Sync.ttcn, line 356 */
i = 0;
current_location.update_lineno(356);
/* LibCommon_Sync.ttcn, line 356 */
for ( ; ; ) {
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 379, TTCN_Location::LOCATION_FUNCTION, "f_selfOrClientSyncAndVerdict");
current_location.update_lineno(382);
/* LibCommon_Sync.ttcn, line 382 */
if ((self == MTC_COMPREF)) {
current_location.update_lineno(384);
/* LibCommon_Sync.ttcn, line 384 */
f__selfSyncAndVerdict(p__syncPoint, p__ret);
}
else {
current_location.update_lineno(386);
/* LibCommon_Sync.ttcn, line 386 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 408, TTCN_Location::LOCATION_FUNCTION, "f_selfOrClientSyncAndVerdictPreamble");
current_location.update_lineno(411);
/* LibCommon_Sync.ttcn, line 411 */
if ((self == MTC_COMPREF)) {
current_location.update_lineno(413);
/* LibCommon_Sync.ttcn, line 413 */
f__selfSyncAndVerdictPreamble(p__syncPoint, p__ret);
}
else {
current_location.update_lineno(415);
/* LibCommon_Sync.ttcn, line 415 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 437, TTCN_Location::LOCATION_FUNCTION, "f_selfOrClientSyncAndVerdictTestBody");
current_location.update_lineno(440);
/* LibCommon_Sync.ttcn, line 440 */
if ((self == MTC_COMPREF)) {
current_location.update_lineno(442);
/* LibCommon_Sync.ttcn, line 442 */
f__selfSyncAndVerdictTestBody(p__syncPoint, p__ret);
}
else {
current_location.update_lineno(444);
/* LibCommon_Sync.ttcn, line 444 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 453, TTCN_Location::LOCATION_FUNCTION, "f_selfOrClientSyncAndVerdictPR");
current_location.update_lineno(456);
/* LibCommon_Sync.ttcn, line 456 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 482, TTCN_Location::LOCATION_FUNCTION, "f_addSyncCompState");
current_location.update_lineno(485);
/* LibCommon_Sync.ttcn, line 485 */
if ((p__ret == LibCommon__VerdictControl::FncRetCode::e__success)) {
current_location.update_lineno(486);
/* LibCommon_Sync.ttcn, line 486 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 506, TTCN_Location::LOCATION_FUNCTION, "f_getTopSyncCompState");
p__state.clean_up();
current_location.update_lineno(509);
/* LibCommon_Sync.ttcn, line 509 */
...
/* LibCommon_Sync.ttcn, line 510 */
p__state = cs_4;
current_location.update_lineno(511);
/* LibCommon_Sync.ttcn, line 511 */
return FALSE;
}
current_location.update_lineno(513);
/* LibCommon_Sync.ttcn, line 513 */
LibCommon__AbstractData::f__popStringStack(ClientSyncComp_component_v__stateStack);
current_location.update_lineno(514);
/* LibCommon_Sync.ttcn, line 514 */
return TRUE;
}

void f__popSyncCompState()
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 524, TTCN_Location::LOCATION_FUNCTION, "f_popSyncCompState");
current_location.update_lineno(526);
/* LibCommon_Sync.ttcn, line 526 */
LibCommon__AbstractData::f__popStringStack(ClientSyncComp_component_v__stateStack);
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 540, TTCN_Location::LOCATION_FUNCTION, "f_peekTopSyncCompState");
p__state.clean_up();
current_location.update_lineno(543);
/* LibCommon_Sync.ttcn, line 543 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 553, TTCN_Location::LOCATION_FUNCTION, "f_isSyncCompStateStackEmpty");
current_location.update_lineno(556);
/* LibCommon_Sync.ttcn, line 556 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 596, TTCN_Location::LOCATION_ALTSTEP, "a_dummyShutDown");
alt_status ret_val = ALT_NO;
current_location.update_lineno(598);
/* LibCommon_Sync.ttcn, line 598 */
switch (BaseSyncComp_component_syncPort.receive(m__syncServerStop, NULL, any_compref, NULL)) {
case ALT_YES:
{
current_location.update_lineno(599);
/* LibCommon_Sync.ttcn, line 599 */
CHARSTRING v__state(cs_5);
current_location.update_lineno(600);
/* LibCommon_Sync.ttcn, line 600 */
BaseSyncComp_component_tc__sync.stop();
current_location.update_lineno(601);
/* LibCommon_Sync.ttcn, line 601 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 621, TTCN_Location::LOCATION_ALTSTEP, "a_shutdown");
alt_status ret_val = ALT_NO;
current_location.update_lineno(623);
/* LibCommon_Sync.ttcn, line 623 */
switch (BaseSyncComp_component_syncPort.receive(m__syncServerStop, NULL, any_compref, NULL)) {
case ALT_YES:
{
current_location.update_lineno(624);
/* LibCommon_Sync.ttcn, line 624 */
BaseSyncComp_component_tc__sync.stop();
current_location.update_lineno(625);
/* LibCommon_Sync.ttcn, line 625 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 653, TTCN_Location::LOCATION_FUNCTION, "f_serverSyncClients");
current_location.update_lineno(655);
/* LibCommon_Sync.ttcn, line 655 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 675, TTCN_Location::LOCATION_FUNCTION, "f_serverSyncClientsIntermediateSync");
current_location.update_lineno(677);
/* LibCommon_Sync.ttcn, line 677 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 692, TTCN_Location::LOCATION_FUNCTION, "f_serverSyncClientsTimed");
current_location.update_lineno(696);
/* LibCommon_Sync.ttcn, line 696 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 712, TTCN_Location::LOCATION_FUNCTION, "f_serverSyncClientsTimedIntermediateSync");
current_location.update_lineno(717);
/* LibCommon_Sync.ttcn, line 717 */
INTEGER v__noOfRecvdSyncMsgs(0);
current_location.update_lineno(717);
/* LibCommon_Sync.ttcn, line 717 */
INTEGER v__noOfRecvdSyncMsgsIntermediate(0);
current_location.update_lineno(718);
/* LibCommon_Sync.ttcn, line 718 */
BOOLEAN v__stopClients(FALSE);
current_location.update_lineno(719);
/* LibCommon_Sync.ttcn, line 719 */
...
/* LibCommon_Sync.ttcn, line 720 */
COMPONENT v__clientRef;
current_location.update_lineno(722);
/* LibCommon_Sync.ttcn, line 722 */
if ((p__syncId == cs_0)) {
...
current_location.update_lineno(733);
/* LibCommon_Sync.ttcn, line 733 */
tmp_5_alt_flag_0 = BaseSyncComp_component_syncPort.receive(m__syncClientReady(p__syncIdIntermediate), NULL, any_compref, &(v__clientRef));
if (tmp_5_alt_flag_0 == ALT_YES) {
current_location.update_lineno(734);
/* LibCommon_Sync.ttcn, line 734 */
...
tmp_8.check_restriction(TR_VALUE, NULL, TRUE);
...
tmp_5_alt_flag_1 = BaseSyncComp_component_syncPort.receive(m__syncClientReady(CHARSTRING_template(p__syncId)), NULL, any_compref, &(v__clientRef));
...
tmp_5_alt_flag_2 = BaseSyncComp_component_syncPort.receive(m__syncClientStop, NULL, any_compref, &(v__clientRef));
...
tmp_5_alt_flag_3 = BaseSyncComp_component_syncPort.receive(m__syncClientReady(CHARSTRING_template(ANY_VALUE)), NULL, any_compref, &(v__clientRef));
...
tmp_5_alt_flag_4 = BaseSyncComp_component_syncPort.receive(SyncCmd_template(ANY_VALUE), NULL, any_compref, NULL);
...
tmp_5_alt_flag_6 = BaseSyncComp_component_tc__sync.timeout();
...
current_location.update_lineno(732);
/* LibCommon_Sync.ttcn, line 732 */
if (tmp_5_alt_flag_0 == ALT_NO && tmp_5_alt_flag_1 == ALT_NO && tmp_5_alt_flag_2 == ALT_NO && tmp_5_alt_flag_3 == ALT_NO && tmp_5_alt_flag_4 == ALT_NO && tmp_5_alt_flag_5 == ALT_NO && tmp_5_alt_flag_6 == ALT_NO && tmp_5_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 732 and 778.");
TTCN_Snapshot::take_new(TRUE);
}
}
current_location.update_lineno(779);
/* LibCommon_Sync.ttcn, line 779 */
if ((v__noOfRecvdSyncMsgsIntermediate != p__NoOfClientIntermediate)) {
current_location.update_lineno(780);
/* LibCommon_Sync.ttcn, line 780 */
v__stopClients = TRUE;
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 810, TTCN_Location::LOCATION_FUNCTION, "f_serverWaitForAllClientsToStop");
current_location.update_lineno(812);
/* LibCommon_Sync.ttcn, line 812 */
BaseSyncComp_component_tc__sync.start();
current_location.update_lineno(813);
/* LibCommon_Sync.ttcn, line 813 */
{
tmp_20:
...
/* LibCommon_Sync.ttcn, line 815 */
BaseSyncComp_component_tc__sync.stop();
current_location.update_lineno(816);
/* LibCommon_Sync.ttcn, line 816 */
...
tmp_20_alt_flag_1 = BaseSyncComp_component_tc__sync.timeout();
...
current_location.update_lineno(813);
/* LibCommon_Sync.ttcn, line 813 */
if (tmp_20_alt_flag_0 == ALT_NO && tmp_20_alt_flag_1 == ALT_NO && tmp_20_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 813 and 822.");
TTCN_Snapshot::take_new(TRUE);
}
}
current_location.update_lineno(823);
/* LibCommon_Sync.ttcn, line 823 */
TTCN_Runtime::setverdict(PASS);
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 836, TTCN_Location::LOCATION_FUNCTION, "f_connect4ClientSync");
current_location.update_lineno(838);
/* LibCommon_Sync.ttcn, line 838 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 847, TTCN_Location::LOCATION_FUNCTION, "f_disconnect4ClientSync");
current_location.update_lineno(849);
/* LibCommon_Sync.ttcn, line 849 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 897, TTCN_Location::LOCATION_FUNCTION, "f_clientSyncAndVerdictPreamble");
current_location.update_lineno(900);
/* LibCommon_Sync.ttcn, line 900 */
LibCommon__VerdictControl::f__setVerdictPreamble(p__ret);
current_location.update_lineno(901);
/* LibCommon_Sync.ttcn, line 901 */
f__clientSync(p__syncId, p__ret);
current_location.update_lineno(902);
/* LibCommon_Sync.ttcn, line 902 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 922, TTCN_Location::LOCATION_FUNCTION, "f_clientSyncAndVerdictTestBody");
current_location.update_lineno(925);
/* LibCommon_Sync.ttcn, line 925 */
LibCommon__VerdictControl::f__setVerdict(p__ret);
current_location.update_lineno(926);
/* LibCommon_Sync.ttcn, line 926 */
f__clientSync(p__syncId, p__ret);
current_location.update_lineno(927);
/* LibCommon_Sync.ttcn, line 927 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 945, TTCN_Location::LOCATION_FUNCTION, "f_clientSyncAndVerdictPostamble");
current_location.update_lineno(948);
/* LibCommon_Sync.ttcn, line 948 */
LibCommon__VerdictControl::f__setVerdictPostamble(p__ret);
current_location.update_lineno(949);
/* LibCommon_Sync.ttcn, line 949 */
f__clientSync(p__syncId, p__ret);
}
...
/* LibCommon_Sync.ttcn, line 987 */
tmp_23_alt_flag_0 = BaseSyncComp_component_syncPort.receive(m__syncServerReady(CHARSTRING_template(p__syncId)), NULL, any_compref, NULL);
if (tmp_23_alt_flag_0 == ALT_YES) {
current_location.update_lineno(988);
/* LibCommon_Sync.ttcn, line 988 */
BaseSyncComp_component_tc__sync.stop();
break;
}
}
...
tmp_23_alt_flag_1 = BaseSyncComp_component_tc__sync.timeout();
...
current_location.update_lineno(986);
/* LibCommon_Sync.ttcn, line 986 */
if (tmp_23_alt_flag_0 == ALT_NO && tmp_23_alt_flag_1 == ALT_NO && tmp_23_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 986 and 992.");
TTCN_Snapshot::take_new(TRUE);
}
}
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1029, TTCN_Location::LOCATION_FUNCTION, "f_clientSendStop");
current_location.update_lineno(1031);
/* LibCommon_Sync.ttcn, line 1031 */
...
/* LibCommon_Sync.ttcn, line 1035 */
tmp_24_alt_flag_0 = BaseSyncComp_component_tc__sync.timeout();
if (tmp_24_alt_flag_0 == ALT_YES) {
current_location.update_lineno(1036);
/* LibCommon_Sync.ttcn, line 1036 */
...
current_location.update_lineno(1034);
/* LibCommon_Sync.ttcn, line 1034 */
if (tmp_24_alt_flag_0 == ALT_NO && tmp_24_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 1034 and 1040.");
TTCN_Snapshot::take_new(TRUE);
}
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1082, TTCN_Location::LOCATION_FUNCTION, "f_connect4SelfSync");
current_location.update_lineno(1084);
/* LibCommon_Sync.ttcn, line 1084 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1093, TTCN_Location::LOCATION_FUNCTION, "f_disconnect4SelfSync");
current_location.update_lineno(1095);
/* LibCommon_Sync.ttcn, line 1095 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1107, TTCN_Location::LOCATION_FUNCTION, "f_selfSyncAndVerdict");
current_location.update_lineno(1110);
/* LibCommon_Sync.ttcn, line 1110 */
if ((ClientSyncComp_component_vc__testcaseStep == TestcaseStep::e__preamble)) {
current_location.update_lineno(1111);
/* LibCommon_Sync.ttcn, line 1111 */
f__selfSyncAndVerdictPreamble(p__syncId, p__ret);
}
else {
current_location.update_lineno(1112);
/* LibCommon_Sync.ttcn, line 1112 */
if ((ClientSyncComp_component_vc__testcaseStep == TestcaseStep::e__testBody)) {
current_location.update_lineno(1113);
/* LibCommon_Sync.ttcn, line 1113 */
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1128, TTCN_Location::LOCATION_FUNCTION, "f_selfSyncAndVerdictPreamble");
current_location.update_lineno(1131);
/* LibCommon_Sync.ttcn, line 1131 */
LibCommon__VerdictControl::f__setVerdictPreOrPostamble(p__ret);
current_location.update_lineno(1132);
/* LibCommon_Sync.ttcn, line 1132 */
f__selfSync(p__syncId, p__ret);
current_location.update_lineno(1133);
/* LibCommon_Sync.ttcn, line 1133 */
ClientSyncComp_component_vc__testcaseStep = TestcaseStep::e__testBody;
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1144, TTCN_Location::LOCATION_FUNCTION, "f_selfSyncAndVerdictTestBody");
current_location.update_lineno(1147);
/* LibCommon_Sync.ttcn, line 1147 */
LibCommon__VerdictControl::f__setVerdict(p__ret);
current_location.update_lineno(1148);
/* LibCommon_Sync.ttcn, line 1148 */
f__selfSync(p__syncId, p__ret);
current_location.update_lineno(1149);
/* LibCommon_Sync.ttcn, line 1149 */
ClientSyncComp_component_vc__testcaseStep = TestcaseStep::e__postamble;
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1160, TTCN_Location::LOCATION_FUNCTION, "f_selfSyncAndVerdictPostamble");
current_location.update_lineno(1163);
/* LibCommon_Sync.ttcn, line 1163 */
LibCommon__VerdictControl::f__setVerdictPreOrPostamble(p__ret);
current_location.update_lineno(1164);
/* LibCommon_Sync.ttcn, line 1164 */
f__selfSync(p__syncId, p__ret);
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1183, TTCN_Location::LOCATION_FUNCTION, "f_selfSync");
current_location.update_lineno(1187);
/* LibCommon_Sync.ttcn, line 1187 */
if ((p__ret != LibCommon__VerdictControl::FncRetCode::e__success)) {
current_location.update_lineno(1188);
/* LibCommon_Sync.ttcn, line 1188 */
f__selfSyncStop();
}
current_location.update_lineno(1190);
/* LibCommon_Sync.ttcn, line 1190 */
if ((p__syncId == cs_0)) {
current_location.update_lineno(1191);
/* LibCommon_Sync.ttcn, line 1191 */
TTCN_Logger::log_str(TTCN_USER, "**** f_selfSync: Successfully passed PREAMBLE synchronization point. ****");
}
else {
current_location.update_lineno(1192);
/* LibCommon_Sync.ttcn, line 1192 */
if ((p__syncId == cs_2)) {
...
/* LibCommon_Sync.ttcn, line 1219 */
tmp_27_alt_flag_0 = BaseSyncComp_component_tc__sync.timeout();
if (tmp_27_alt_flag_0 == ALT_YES) {
current_location.update_lineno(1220);
/* LibCommon_Sync.ttcn, line 1220 */
...
current_location.update_lineno(1218);
/* LibCommon_Sync.ttcn, line 1218 */
if (tmp_27_alt_flag_0 == ALT_NO && tmp_27_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 1218 and 1224.");
TTCN_Snapshot::take_new(TRUE);
}
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1264, TTCN_Location::LOCATION_TEMPLATE, "m_syncClientReady");
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1268, TTCN_Location::LOCATION_TEMPLATE, "m_syncServerReady");
SyncCmd_template ret_val;
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1289, TTCN_Location::LOCATION_FUNCTION, "f_serverSendToAllClients");
current_location.update_lineno(1292);
/* LibCommon_Sync.ttcn, line 1292 */
INTEGER i(0);
current_location.update_lineno(1293);
/* LibCommon_Sync.ttcn, line 1293 */
i = 0;
current_location.update_lineno(1293);
/* LibCommon_Sync.ttcn, line 1293 */
for ( ; ; ) {
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1306, TTCN_Location::LOCATION_FUNCTION, "f_serverWaitForAllClientsToShutDown");
current_location.update_lineno(1309);
/* LibCommon_Sync.ttcn, line 1309 */
ServerSyncComp_component_tc__shutDown.start(PX__TSHUT__DOWN__TIME__LIMIT);
current_location.update_lineno(1310);
/* LibCommon_Sync.ttcn, line 1310 */
{
tmp_30:
...
/* LibCommon_Sync.ttcn, line 1311 */
tmp_30_alt_flag_0 = BaseSyncComp_component_syncPort.receive(any_compref, NULL);
if (tmp_30_alt_flag_0 == ALT_YES) break;
}
if (tmp_30_alt_flag_1 == ALT_MAYBE) {
current_location.update_lineno(1314);
/* LibCommon_Sync.ttcn, line 1314 */
...
/* LibCommon_Sync.ttcn, line 1318 */
tmp_30_alt_flag_2 = ServerSyncComp_component_tc__shutDown.timeout();
if (tmp_30_alt_flag_2 == ALT_YES) {
current_location.update_lineno(1319);
/* LibCommon_Sync.ttcn, line 1319 */
...
current_location.update_lineno(1310);
/* LibCommon_Sync.ttcn, line 1310 */
if (tmp_30_alt_flag_0 == ALT_NO && tmp_30_alt_flag_1 == ALT_NO && tmp_30_alt_flag_2 == ALT_NO && tmp_30_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 1310 and 1321.");
TTCN_Snapshot::take_new(TRUE);
}
}
current_location.update_lineno(1323);
/* LibCommon_Sync.ttcn, line 1323 */
TTCN_Runtime::setverdict(INCONC);
...
/* LibCommon_Sync.ttcn, line 1326 */
BaseSyncComp_component_tc__sync.start(PX__TSYNC__TIME__LIMIT);
current_location.update_lineno(1327);
/* LibCommon_Sync.ttcn, line 1327 */
{
tmp_31:
...
/* LibCommon_Sync.ttcn, line 1328 */
tmp_31_alt_flag_0 = BaseSyncComp_component_tc__sync.timeout();
...
current_location.update_lineno(1327);
/* LibCommon_Sync.ttcn, line 1327 */
if (tmp_31_alt_flag_0 == ALT_NO && tmp_31_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file LibCommon_Sync.ttcn between lines 1327 and 1333.");
TTCN_Snapshot::take_new(TRUE);
}
}
...
{
TTCN_Location current_location("LibCommon_Sync.ttcn", 1338, TTCN_Location::LOCATION_FUNCTION, "f_isPresentInArray");
...
if (!strcmp(par_name, "PX_TSYNC_TIME_LIMIT")) {
return modulepar_PX__TSYNC__TIME__LIMIT.get_param(param_name);
} else if (!strcmp(par_name, "PX_TSHUT_DOWN_TIME_LIMIT")) {
return modulepar_PX__TSHUT__DOWN__TIME__LIMIT.get_param(param_name);
} else return NULL;
}
