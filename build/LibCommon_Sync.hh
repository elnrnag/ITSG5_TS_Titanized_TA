...
alt_status receive(const SyncCmd_template& value_template, SyncCmd *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status check_receive(const SyncCmd_template& value_template, SyncCmd *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
alt_status trigger(const SyncCmd_template& value_template, SyncCmd *value_ptr, const COMPONENT_template& sender_template, COMPONENT *sender_ptr);
private:
