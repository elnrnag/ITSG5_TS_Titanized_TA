...
public class FntpPort extends ProtocolPort implements IEthernetSpecific {
     ...
     */
    public FntpPort(String portName, String componentName, String lowerStackDesc, String linkLayerAddress) {
    ...
    public void receive(byte[] message, Map<String, Object> lowerInfo) {
        // Encode with FntpInd indication header
        // Extract LINK_LAYER_DESTINATION
        byte[] fntpInd = ByteHelper.concat(message, (byte[])lowerInfo.get(EthernetLayer.LINK_LAYER_DESTINATION));
            super.receive(fntpInd, lowerInfo);
    }
    ...
    public boolean send(byte[] message) {
        ByteHelper.dump("FntpPort.send", message);
        HashMap<String, Object> params = new HashMap<String, Object>();
        return send(message, params);
    }

    public boolean triggerInSapPrimitiveUp(byte[] inSapPrimitiveUp) {
        ByteHelper.dump("FntpPort.triggerInSapPrimitiveUp", inSapPrimitiveUp);
        HashMap<String, Object> params = new HashMap<String, Object>();
