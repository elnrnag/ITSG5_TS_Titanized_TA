...
#ifndef UpperTesterMapSpatPort_HH
#define UpperTesterMapSpatPort_HH
...
namespace LibItsMapSpat__TestSystem {
  ...
  class UpperTesterMapSpatPort : public UpperTesterMapSpatPort_BASE {
  public:
    UpperTesterMapSpatPort(const char *par_port_name = NULL);
    ~UpperTesterMapSpatPort();
  ...
  protected:
    ...
    void outgoing_send(const LibItsMapSpat__TypesAndValues::UtMapSpatTrigger& send_par);
