...
#ifndef UpperTesterCAMPort_HH
#define UpperTesterCAMPort_HH
...
class UpperTesterCAMPort : public UpperTesterCAMPort_BASE {
public:
	UpperTesterCAMPort(const char *par_port_name = NULL);
	~UpperTesterCAMPort();
