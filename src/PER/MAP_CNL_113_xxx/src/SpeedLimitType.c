...
static asn_per_constraints_t asn_PER_type_SpeedLimitType_constr_1 GCC_NOTUSED = {
	{ (asn_per_constraint_t::asn_per_constraint_flags)((int)(asn_per_constraint_t::APC_CONSTRAINED) | (int)(asn_per_constraint_t::APC_EXTENSIBLE)),  4,  4,  0,  12 }	/* (0..12,...) */,
	{ asn_per_constraint_t::APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_SpeedLimitType_value2enum_1[] = {
	{ 0,	7,	"unknown" },
...
static unsigned int asn_MAP_SpeedLimitType_enum2value_1[] = {
...
static asn_INTEGER_specifics_t asn_SPC_SpeedLimitType_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_SpeedLimitType_tags_1[] = {
