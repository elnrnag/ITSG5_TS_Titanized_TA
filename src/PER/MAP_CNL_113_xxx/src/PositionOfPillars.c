...
static asn_per_constraints_t asn_PER_type_PositionOfPillars_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ (asn_per_constraint_t::asn_per_constraint_flags)((int)(asn_per_constraint_t::APC_CONSTRAINED) | (int)(asn_per_constraint_t::APC_EXTENSIBLE)),  2,  2,  1,  3 }	/* (SIZE(1..3,...)) */,
