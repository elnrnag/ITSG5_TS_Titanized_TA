...
static asn_per_constraints_t asn_PER_type_Longitude_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 32, -1, -1800000000,  1800000001 }	/* (-1800000000..1800000001) */,
