...
asn_dec_rval_t
MinuteOfTheYear_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
MinuteOfTheYear_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_MinuteOfTheYear_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 20, -1,  0,  527040 }	/* (0..527040) */,
...
asn_TYPE_descriptor_t asn_DEF_MinuteOfTheYear = {
	...
	MinuteOfTheYear_decode_uper,
	MinuteOfTheYear_encode_uper,
