...
static asn_TYPE_member_t asn_MBR_RestrictionClassAssignment_1[] = {
...
static ber_tlv_tag_t asn_DEF_RestrictionClassAssignment_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RestrictionClassAssignment_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* id */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* users */
};
static asn_SEQUENCE_specifics_t asn_SPC_RestrictionClassAssignment_specs_1 = {
