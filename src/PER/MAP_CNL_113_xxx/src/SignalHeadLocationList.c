...
static asn_per_constraints_t asn_PER_type_SignalHeadLocationList_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ asn_per_constraint_t::APC_CONSTRAINED,	 5,  5,  1,  20 }	/* (SIZE(1..20)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_SignalHeadLocationList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_SignalHeadLocationList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_SignalHeadLocationList_specs_1 = {
