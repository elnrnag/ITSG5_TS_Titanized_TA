...
static asn_TYPE_member_t asn_MBR_Node_XY_22b_1[] = {
...
static ber_tlv_tag_t asn_DEF_Node_XY_22b_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_Node_XY_22b_tag2el_1[] = {
