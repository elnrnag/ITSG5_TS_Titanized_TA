...
asn_dec_rval_t
VehicleWidth_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleWidth_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_VehicleWidth_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 6,  6,  1,  62 }	/* (1..62) */,
...
asn_TYPE_descriptor_t asn_DEF_VehicleWidth = {
	...
	VehicleWidth_decode_uper,
	VehicleWidth_encode_uper,
