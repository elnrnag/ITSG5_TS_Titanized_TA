...
asn_dec_rval_t
DescriptiveName_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DescriptiveName_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_DescriptiveName_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 7,  7,  0,  127 }	/* (0..127) */,
	{ asn_per_constraint_t::APC_CONSTRAINED,	 6,  6,  1,  63 }	/* (SIZE(1..63)) */,
...
asn_TYPE_descriptor_t asn_DEF_DescriptiveName = {
	...
	DescriptiveName_decode_uper,
	DescriptiveName_encode_uper,
