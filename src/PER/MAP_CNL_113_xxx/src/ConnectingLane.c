...
static int asn_MAP_ConnectingLane_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_ConnectingLane_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ConnectingLane_tag2el_1[] = {
