...
asn_dec_rval_t
SteeringWheelAngleConfidence_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SteeringWheelAngleConfidence_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_SteeringWheelAngleConfidence_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_SteeringWheelAngleConfidence = {
	...
	SteeringWheelAngleConfidence_decode_uper,
	SteeringWheelAngleConfidence_encode_uper,
