...
static int asn_MAP_RoadWorksContainerBasic_oms_1[] = { 0, 2 };
static ber_tlv_tag_t asn_DEF_RoadWorksContainerBasic_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RoadWorksContainerBasic_tag2el_1[] = {
