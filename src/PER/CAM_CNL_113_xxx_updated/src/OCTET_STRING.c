...
static asn_per_constraints_t asn_DEF_OCTET_STRING_constraints = {
	{ asn_per_constraint_t::APC_CONSTRAINED, 8, 8, 0, 255 },
	{ asn_per_constraint_t::APC_SEMI_CONSTRAINED, -1, -1, 0, 0 },
	0, 0
};
...
OCTET_STRING_decode_ber(asn_codec_ctx_t *opt_codec_ctx,
	...
	int tlv_constr;
	enum asn_OCTET_STRING_specifics_t::asn_OS_Subvariant type_variant = specs->subvariant;
	...
	ASN_DEBUG("Took %ld bytes to encode %s: [%s]:%ld",
		...
		(type_variant == asn_OCTET_STRING_specifics_t::ASN_OSUBV_STR) ? (char *)st->buf : "<data>",
		(long)st->size);
...
OCTET_STRING_decode_uper(asn_codec_ctx_t *opt_codec_ctx,
	...
	case asn_OCTET_STRING_specifics_t::ASN_OSUBV_STR:
		...
		if(cval->flags & asn_per_constraint_t::APC_CONSTRAINED)
			unit_bits = cval->range_bits;
		bpc = OS__BPC_CHAR;
		break;
	case asn_OCTET_STRING_specifics_t::ASN_OSUBV_U16:
		canonical_unit_bits = unit_bits = 16;
		if(cval->flags & asn_per_constraint_t::APC_CONSTRAINED)
			unit_bits = cval->range_bits;
		bpc = OS__BPC_U16;
		break;
	case asn_OCTET_STRING_specifics_t::ASN_OSUBV_U32:
	...
	ASN_DEBUG("PER Decoding %s size %ld .. %ld bits %d",
		csiz->flags & asn_per_constraint_t::APC_EXTENSIBLE ? "extensible" : "non-extensible",
		csiz->lower_bound, csiz->upper_bound, csiz->effective_bits);

	if(csiz->flags & asn_per_constraint_t::APC_EXTENSIBLE) {
...
OCTET_STRING_encode_uper(asn_TYPE_descriptor_t *td,
	...
	ct_extensible = csiz->flags & asn_per_constraint_t::APC_EXTENSIBLE;
