...
static asn_TYPE_member_t asn_MBR_RSUContainerHighFrequency_1[] = {
...
static int asn_MAP_RSUContainerHighFrequency_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_RSUContainerHighFrequency_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RSUContainerHighFrequency_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* protectedCommunicationZonesRSU */
};
static asn_SEQUENCE_specifics_t asn_SPC_RSUContainerHighFrequency_specs_1 = {
