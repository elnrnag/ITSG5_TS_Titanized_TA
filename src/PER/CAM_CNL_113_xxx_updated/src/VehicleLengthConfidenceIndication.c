...
int
VehicleLengthConfidenceIndication_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
VehicleLengthConfidenceIndication_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
VehicleLengthConfidenceIndication_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	VehicleLengthConfidenceIndication_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
VehicleLengthConfidenceIndication_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
VehicleLengthConfidenceIndication_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleLengthConfidenceIndication_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
VehicleLengthConfidenceIndication_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleLengthConfidenceIndication_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
VehicleLengthConfidenceIndication_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleLengthConfidenceIndication_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_VehicleLengthConfidenceIndication_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 3,  3,  0,  4 }	/* (0..4) */,
