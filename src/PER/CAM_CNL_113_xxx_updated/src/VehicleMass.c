...
asn_dec_rval_t
VehicleMass_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleMass_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_VehicleMass_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 10,  10,  1,  1024 }	/* (1..1024) */,
...
asn_TYPE_descriptor_t asn_DEF_VehicleMass = {
	...
	VehicleMass_decode_uper,
	VehicleMass_encode_uper,
