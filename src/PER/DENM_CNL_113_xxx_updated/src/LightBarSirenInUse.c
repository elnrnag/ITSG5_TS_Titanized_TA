...
int
LightBarSirenInUse_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
LightBarSirenInUse_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
LightBarSirenInUse_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	LightBarSirenInUse_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
LightBarSirenInUse_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
LightBarSirenInUse_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
LightBarSirenInUse_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
LightBarSirenInUse_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
LightBarSirenInUse_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
LightBarSirenInUse_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
LightBarSirenInUse_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_LightBarSirenInUse_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ asn_per_constraint_t::APC_CONSTRAINED,	 0,  0,  2,  2 }	/* (SIZE(2..2)) */,
	0, 0	/* No PER value map */
};
static ber_tlv_tag_t asn_DEF_LightBarSirenInUse_tags_1[] = {
