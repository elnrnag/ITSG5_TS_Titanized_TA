...
asn_dec_rval_t
Termination_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Termination_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_Termination_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ asn_per_constraint_t::APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_Termination_value2enum_1[] = {
	{ 0,	14,	"isCancellation" },
	{ 1,	10,	"isNegation" }
};
static unsigned int asn_MAP_Termination_enum2value_1[] = {
	0,	/* isCancellation(0) */
	1	/* isNegation(1) */
};
static asn_INTEGER_specifics_t asn_SPC_Termination_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_Termination_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_Termination = {
	...
	Termination_decode_uper,
	Termination_encode_uper,
