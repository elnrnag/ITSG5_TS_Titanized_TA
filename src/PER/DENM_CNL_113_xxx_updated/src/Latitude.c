...
asn_dec_rval_t
Latitude_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Latitude_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_Latitude_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 31, -1, -900000000,  900000001 }	/* (-900000000..900000001) */,
...
asn_TYPE_descriptor_t asn_DEF_Latitude = {
	...
	Latitude_decode_xer,
	Latitude_encode_xer,
	Latitude_decode_uper,
	Latitude_encode_uper,
