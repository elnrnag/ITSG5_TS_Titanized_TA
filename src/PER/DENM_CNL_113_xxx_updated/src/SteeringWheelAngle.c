...
static asn_TYPE_member_t asn_MBR_SteeringWheelAngle_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_SteeringWheelAngle_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* steeringWheelAngleValue */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* steeringWheelAngleConfidence */
};
static asn_SEQUENCE_specifics_t asn_SPC_SteeringWheelAngle_specs_1 = {
