...
static asn_TYPE_member_t asn_MBR_DecentralizedEnvironmentalNotificationMessage_1[] = {
...
static int asn_MAP_DecentralizedEnvironmentalNotificationMessage_oms_1[] = { 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_DecentralizedEnvironmentalNotificationMessage_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DecentralizedEnvironmentalNotificationMessage_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_DecentralizedEnvironmentalNotificationMessage_specs_1 = {
