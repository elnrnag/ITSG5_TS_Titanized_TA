...
asn_dec_rval_t
TimeMark_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TimeMark_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_TimeMark_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 16,  16,  0,  36002 }	/* (0..36002) */,
...
asn_TYPE_descriptor_t asn_DEF_TimeMark = {
	...
	TimeMark_decode_xer,
	TimeMark_encode_xer,
	TimeMark_decode_uper,
	TimeMark_encode_uper,
