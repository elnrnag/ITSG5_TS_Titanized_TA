...
asn_dec_rval_t
LaneWidth_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
LaneWidth_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_LaneWidth_constr_1 GCC_NOTUSED = {
	{ asn_per_constraint_t::APC_CONSTRAINED,	 15,  15,  0,  32767 }	/* (0..32767) */,
...
asn_TYPE_descriptor_t asn_DEF_LaneWidth = {
	...
	LaneWidth_decode_uper,
	LaneWidth_encode_uper,
