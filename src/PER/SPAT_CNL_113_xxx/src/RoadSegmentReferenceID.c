...
static asn_TYPE_member_t asn_MBR_RoadSegmentReferenceID_1[] = {
...
static int asn_MAP_RoadSegmentReferenceID_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_RoadSegmentReferenceID_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RoadSegmentReferenceID_tag2el_1[] = {
