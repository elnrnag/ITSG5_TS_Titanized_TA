...
int
WaitOnStopline_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
WaitOnStopline_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
WaitOnStopline_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	WaitOnStopline_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
WaitOnStopline_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
WaitOnStopline_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
WaitOnStopline_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
WaitOnStopline_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
WaitOnStopline_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
WaitOnStopline_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
WaitOnStopline_encode_uper(asn_TYPE_descriptor_t *td,
...
static ber_tlv_tag_t asn_DEF_WaitOnStopline_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_WaitOnStopline = {
	...
	"WaitOnStopline",
	WaitOnStopline_free,
	WaitOnStopline_print,
	WaitOnStopline_constraint,
	WaitOnStopline_decode_ber,
	WaitOnStopline_encode_der,
	WaitOnStopline_decode_xer,
	WaitOnStopline_encode_xer,
	WaitOnStopline_decode_uper,
	WaitOnStopline_encode_uper,
