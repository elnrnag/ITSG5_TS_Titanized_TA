...
asn_dec_rval_t
AccelerationConfidence_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AccelerationConfidence_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_AccelerationConfidence = {
	...
	AccelerationConfidence_encode_uper,
